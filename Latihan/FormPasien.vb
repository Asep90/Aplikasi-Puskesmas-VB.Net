...
Public Class FormPasien
    ...
    Private Sub btnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSimpan.Click
        Call bukaDB()
        CMD = New MySqlCommand("SELECT Kode_Pasien from Pasien Where Kode_pasien ='" & txtKode_Pasien.Text & "'", Koneksi)
        ...
        If btnTambah.Enabled = False Then
            ...
            Else
                If MessageBox.Show("Simpan data baru? ", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    Call bukaDB()
                    Simpan = "INSERT INTO Pasien (Kode_Pasien,Nama_Pasien,Kelamin,Alamat_Pasien,TglLahir,NoKTP,NoHP) VALUES ('" & txtKode_Pasien.Text & "','" & txtNama_Pasien.Text & "','" & txtKelamin.Text & "','" & txtAlamat_Pasien.Text & "','" & txtTglLahir.Text & "','" & txtNoKTP.Text & "','" & txtNoHP.Text & "')"
        ...
        Else
            If txtKode_Pasien.Text <> "" Then
                If MessageBox.Show("Apakah Anda Yakin akan Menghahapus data tabel diatas!", "konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    Call bukaDB()
                    Hapus = "DELETE From Pasien where Kode_Pasien='" & txtKode_Pasien.Text & "'"
